...
if (nwmax >= nw+2) then
   w(ixO^S,nw+2) = myM%alpha(ixO^S)
end if

if (nwmax >= nw+3) then
   w(ixO^S,nw+3) = myM%g(1,1)%elem(ixO^S)
end if

if (nwmax >= nw+4) then
   w(ixO^S,nw+4) = myM%g(1,2)%elem(ixO^S)
end if

if (nwmax >= nw+5) then
   w(ixO^S,nw+5) = myM%g(1,3)%elem(ixO^S)
end if

if (nwmax >= nw+6) then
   w(ixO^S,nw+6) = myM%g(2,2)%elem(ixO^S)
end if

if (nwmax >= nw+7) then
   w(ixO^S,nw+7) = myM%g(2,3)%elem(ixO^S)
end if

if (nwmax >= nw+8) then
   w(ixO^S,nw+8) = myM%g(3,3)%elem(ixO^S)
end if

if (nwmax >= nw+9) then
   w(ixO^S,nw+9) = myM%beta(1)%elem(ixO^S)
end if

if (nwmax >= nw+10) then
   w(ixO^S,nw+10) = myM%beta(2)%elem(ixO^S)
end if

if (nwmax >= nw+11) then
   w(ixO^S,nw+11) = myM%beta(3)%elem(ixO^S)
end if
